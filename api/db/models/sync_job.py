...
class SyncJob(Base):
    ...
    causa_penal_id: Mapped[uuid.UUID | None] = mapped_column(
        UUID(as_uuid=True), ForeignKey("causas_penal.id", ondelete="CASCADE"), nullable=True, index=True
    )
    ...
    __table_args__ = (
        ...
        CheckConstraint(
            ...
            "+ (CASE WHEN causa_penal_id IS NOT NULL THEN 1 ELSE 0 END) = 1",

...
url : /catalogo/tribunales?competencia=cobranza


el usuario se debe loguear con un metodo auth
luego de obtener el bearer token el usuario podra consumir el metodo de sincronizar_cobranza Asincrono:
Request:
{
    "corte":90,
    "tribunal": 387, # el tribunal es distinto al de cobranza, debemos scrapear antes todos los tribunales de laboral
    "tipo": "A",
    "rol": 1,
    "anio": 2025
}
...
sincronizar_cobranza los campos rut, clave y metodo_login (1 = Clave Poder Judicial,
...
Luego de sincronizar, el usuario podrá consultar causa con el método consultar_cobranza:
Request:
{
    "corte":90,
    "tribunal": 387,
...
Luego de sincronizar, el usuario podrá consultar causa con el método consultar_movimientos_cobranza:
Request:
{
    "identificador": [GUID]
}

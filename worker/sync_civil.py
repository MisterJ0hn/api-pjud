...
async def sincronizar_causa(
    ...
    *,
    ...
    # ebook se vuelve a descargar SIEMPRE (PJUD lo regenera completo cada vez que se
    # agrega un documento nuevo a la causa, y no hay forma de saber desde afuera si
    # cambio sin bajarlo).
